            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>LINK</label>
                            <input type="text" name="link" value="{{ old('link') }}" placeholder="Enter image link" class="form-control @error('link') is-invalid @enderror">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $slider->link }}</td>
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-danger" onClick="Delete(this.id)" id="{{ $slider->id }}">
